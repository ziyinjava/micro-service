package com.ziyin.user.controller;

import com.ziyin.thrift.user.UserInfo;
import com.ziyin.user.controller.thrift.ServiceProvider;
import com.ziyin.thrift.user.dto.UserDTO;
import com.ziyin.user.redis.RedisClient;
import com.ziyin.user.response.LoginResponse;
import com.ziyin.user.response.Response;
...
/**
 * @author ziyin
 @create 2018-12-2018/12/30-5:58
 */
@Controller
@RequestMapping("/user")
